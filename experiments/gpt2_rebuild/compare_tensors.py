...
def main() -> None:
    ...
    parser.add_argument("--torch-dir", type=str, default="experiments/gpt2_rebuild/outputs/pytorch/step_0000")
    parser.add_argument("--out-dir", type=str, default="experiments/gpt2_rebuild/outputs/compare")
