#!/usr/bin/env python3
"""PyTorch functional parity for GPT2 reimplementation."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="GPT2 reimpl parity (PyTorch)")
    ...
    parser.add_argument("--out-dir", type=str, default="experiments/gpt2_reimpl/outputs/pytorch/step_0000")
    ...
    diff = (logits - target).to(torch.bfloat16)
