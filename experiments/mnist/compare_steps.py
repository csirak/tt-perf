...
def main() -> None:
    ...
    parser.add_argument("--torch-dir", type=str, default="experiments/mnist/outputs/pytorch")
    parser.add_argument("--out-dir", type=str, default="experiments/mnist/outputs/compare")
