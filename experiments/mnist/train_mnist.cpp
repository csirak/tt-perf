...
//
// MNIST MLP parity experiment (TTNN C++ vs PyTorch functional)
...
int main() {
    const char* env_path = std::getenv("MNIST_CONFIG");
    std::string config_path = env_path
        ? env_path
        : "/home/howard/ttnn-perf/experiments/mnist/default.yaml";
