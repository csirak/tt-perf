...
def main() -> None:
    ...
    parser.add_argument("--torch-dir", type=str, default="train/gpt2/outputs/pytorch/step_0000")
    parser.add_argument("--out-dir", type=str, default="train/gpt2/outputs/compare")
